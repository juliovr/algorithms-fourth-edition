...
public class Exercise40_SpanningForest {
    ...
    private static class SpanningForest {
        ...
        private void computeSpanningForest(Graph graph) {
            ST<Integer, Bag<Integer>> spanningTreeVertices = new ST<>();
        ...
        private void dfs(Graph graph, int parent, int v, ST<Integer, Bag<Integer>> spanningTreeVertices) {
            marked[v] = true;
        ...
        private Graph makeSpanningTree(ST<Integer, Bag<Integer>> spanningTreeVertices) {
            int maxIndex = 0;
            ...
            for (int v : spanningTreeVertices) {
